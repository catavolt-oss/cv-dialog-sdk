                        ...
                        children: [
                            {
                                ...
                                iconUrl:
                                    'https://s3-eu-west-1.amazonaws.com/res-euw.catavolt.net/catavoltres/images/action/catavolt.png',
                                id: 'AAABACcaAAAAAGBT',
                            ...
                            },
                            {
                                ...
                                actionId: '#refresh',
                                iconUrl:
                                    'https://s3-eu-west-1.amazonaws.com/res-euw.catavolt.net/catavoltres/images/action/refresh.png',
                                id: 'REFRESH',
                                label: 'Refresh',
                                type: 'hxgn.api.dialog.Menu'
                            },
                            {
                                ...
                                actionId: 'export',
                                iconUrl:
                                    'https://s3-eu-west-1.amazonaws.com/res-euw.catavolt.net/catavoltres/images/action/export.png',
                                id: 'EXPORT',
                                label: 'Export',
                                type: 'hxgn.api.dialog.Menu'
                            }
                    ...
                    menu: {
                        ...
                        children: [
                            ...
                            },
                            {
                                ...
                                iconUrl:
                                    'https://s3-eu-west-1.amazonaws.com/res-euw.catavolt.net/catavoltres/images/action/calculateStatistics.png',
