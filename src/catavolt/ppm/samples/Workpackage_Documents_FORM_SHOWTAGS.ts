/**
 */
export class SdaGetDocumentsDialogJsonSampleSHOWTAGS {

    private static PATH = 'tenants/${tenantId}/sessions/${sessionId}/dialogs/20';
    ...
    private static RESPONSE = {
        ...
        "view": {
            ...
            "id": "FORM_AAABACcXAAAAAChO_13_449825119:9081:-1997598716:20_null_1",
            "title": "Default",
            "menu": {
                "visible": false,
                "children": [{
        ...
        "children": [{
            ...
            "view": {
                ...
                "id": "DETAILS_AAABACcdAAAAAIFy_7_449825119:9081:-1997598716:20_null_1",
                "menu": {
                    "visible": false,
                    "children": [{
                        "visible": true,
                ...
                "rows": [[{
                    ...
                    "values": [{"type": "hxgn.api.dialog.LabelCellValue", "value": "Creation User"}],
                    "type": "hxgn.api.dialog.Cell"
                }, {
                    "values": [{
                        "autoFillCapable": false,
            ...
            "dialogOrigin": {
                ...
                "ToQuery": {"DataObject": "Documents", "Query": "WorkPackage", "DataSource": "HexagonSDA"},
                "Detail": "Documents",
                "DataSource": "HexagonSDA"
            },
            "recordDef": {
            ...
            "domainClassName": "cx.AAABACcSAAAAACfi.com.catavolt.odata.hexagonsdaopAAABACcRAAAAACdo.Intergraph.SPF.Server.API.Model.FusionDocument",
            "view": {
                "fixedColumnCount": 3,
                ...
                "style": "DEFAULT",
                "id": "LIST_AAABACcZAAAAAChP_2_449825119:9081:-1997598716:20_null_1",
                "title": "Documents",
                "menu": {
                    "visible": false,
                    "children": [{
            ...
            "selectedViewId": "AAABACcTAAAAACfx"
        }],
