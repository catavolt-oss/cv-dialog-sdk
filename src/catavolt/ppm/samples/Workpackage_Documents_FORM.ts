/**
 * Editor dialog: Workpackage_Documents_FORM
 *     Editor dialog: Workpackage_Documents_Properties
 *     Query dialog: Workpackage_Documents_Documents
 */
export class Workpackage_Documents_FORM {
