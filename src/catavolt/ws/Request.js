...
var Promise_1 = require('../fp/Promise');
...
var XMLHttpClient = (function () {
    ...
    XMLHttpClient.prototype.jsonCall = function (targetUrl, jsonObj, method, timeoutMillis) {
        ...
        var promise = new Promise_1.Promise("XMLHttpClient::" + targetUrl + ":" + body);
        ...
        var successCallback = function (request) {
            try {
                Log_1.Log.debug("XMLHttpClient: Got successful response: " + request.responseText);
        ...
        var errorCallback = function (request) {
            Log_1.Log.error('XMLHttpClient::jsonCall: call failed with ' + request.status + ":" + request.statusText);
            promise.failure('XMLHttpClient::jsonCall: call failed with ' + request.status + ":" + request.statusText);
        };
        var timeoutCallback = function () {
            if (promise.isComplete()) {
                Log_1.Log.error('XMLHttpClient::jsonCall: Timeoutreceived but Promise was already complete.');
            }
            else {
                Log_1.Log.error('XMLHttpClient::jsonCall: Timeoutreceived.');
        ...
        Log_1.Log.debug("XmlHttpClient: Calling: " + targetUrl);
        Log_1.Log.debug("XmlHttpClient: body: " + body);
...
var Call = (function () {
    ...
    Call.prototype.cancel = function () {
        Log_1.Log.error("Needs implementation", "Call", "cancel");
    };
    Call.prototype.perform = function () {
        if (this._performed) {
            return Future_1.Future.createFailedFuture("Call::perform", "Call:perform(): Call is already performed");
        }
        this._performed = true;
        if (!this._systemContext) {
            return Future_1.Future.createFailedFuture("Call::perform", "Call:perform(): SystemContext cannot be null");
        }
        var jsonObj = {
            id: this._callId,
            method: this._method,
...
var Get = (function () {
    function Get(url) {
        ...
        this._url = url;
        this._performed = false;
        this._promise = new Promise_1.Promise("catavolt.ws.Get");
        this.timeoutMillis = 30000;
    }
    ...
    Get.prototype.cancel = function () {
        Log_1.Log.error("Needs implementation", "Get", "cancel");
    };
    Get.prototype.perform = function () {
        if (this._performed) {
            return this.complete(new Failure_1.Failure("Get:perform(): Get is already performed")).future;
        }
        this._performed = true;
