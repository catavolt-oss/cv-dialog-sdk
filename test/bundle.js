...
var _util = require('./catavolt/util');
...
var _dialog = require('./catavolt/dialog');
...
},{"./fp":3,"./util":4,"./ws":5}],3:[function(require,module,exports){
"use strict";
...
},{"./fp":3,"./util":4}],6:[function(require,module,exports){
'use strict';

var _catavolt = require('../src/catavolt');
...
},{"../src/catavolt":1}],7:[function(require,module,exports){
'use strict';
...
xdescribe("AppContext::login", function () {
    it("should login successfully with valid creds", function (done) {
        _catavolt.AppContext.singleton.login(SERVICE_PATH, tenantId, clientType, userId, password).onComplete(function (appWinDefTry) {
            _catavolt.Log.info(_catavolt.Log.formatRecString(appWinDefTry));
            _catavolt.Log.info(_catavolt.Log.formatRecString(_catavolt.AppContext.singleton.sessionContextTry));
            _catavolt.Log.info(_catavolt.Log.formatRecString(_catavolt.AppContext.singleton.tenantSettingsTry));
            expect(_catavolt.AppContext.singleton.appWinDefTry.success.workbenches.length).toBeGreaterThan(0);
            done();
        });
    });
});
xdescribe("AppContext::performLaunchAction", function () {
    it("should peform launch action successfully", function (done) {
        var launchAction = _catavolt.AppContext.singleton.appWinDefTry.success.workbenches[0].workbenchLaunchActions[0];
        _catavolt.AppContext.singleton.performLaunchAction(launchAction).onComplete(function (navRequestTry) {
            _catavolt.Log.debug("completed with: " + navRequestTry);
            if (navRequestTry.isFailure) {
                _catavolt.Log.debug(navRequestTry.failure);
            }
...
},{"../src/catavolt":1}],8:[function(require,module,exports){
'use strict';
...
xdescribe("Future", function () {
    it("should be created successfully with Try", function () {
        var f = _catavolt.Future.createCompletedFuture("test", new _catavolt.Success("successfulValue"));
    });
});


},{"../src/catavolt":1}],9:[function(require,module,exports){
"use strict";
...
xdescribe("Request::XMLHttpClient", function () {
    it("Should get endpoint successfully", function (done) {
        ...
        var client = new _catavolt.XMLHttpClient();
