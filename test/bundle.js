...
"use strict";function _typeof(obj){return obj&&typeof Symbol!=="undefined"&&obj.constructor===Symbol?"symbol":typeof obj}var __extends=undefined&&undefined.__extends||function(d,b){for(var p in b){if(b.hasOwnProperty(p))d[p]=b[p]}function __(){this.constructor=d}d.prototype=b===null?Object.create(b):(__.prototype=b.prototype,new __)};var fp_1=require("./fp");var fp_2=require("./fp");var fp_3=require("./fp");var util_1=require("./util");var util_2=require("./util");var fp_4=require("./fp");var fp_5=require("./fp");var util_3=require("./util");var util_4=require("./util");var util_5=require("./util");var ws_1=require("./ws");var ws_2=require("./ws"); /*
 IMPORTANT!
 ...
 * *********************************
 */var PaneContext=(function(){function PaneContext(paneRef){this._lastRefreshTime=new Date(0);this._parentContext=null;this._paneRef=null;this._paneRef=paneRef;this._binaryCache={}}PaneContext.resolveSettingsFromNavRequest=function(initialSettings,navRequest){var result=util_2.ObjUtil.addAllProps(initialSettings,{});if(navRequest instanceof FormContext){util_2.ObjUtil.addAllProps(navRequest.dialogRedirection.fromDialogProperties,result);util_2.ObjUtil.addAllProps(navRequest.offlineProps,result)}else if(navRequest instanceof NullNavRequest){util_2.ObjUtil.addAllProps(navRequest.fromDialogProperties,result)}var destroyed=result["fromDialogDestroyed"];if(destroyed)result["destroyed"]=true;return result};Object.defineProperty(PaneContext.prototype,"actionSource",{get:function get(){return this.parentContext?this.parentContext.actionSource:null},enumerable:true,configurable:true});Object.defineProperty(PaneContext.prototype,"dialogAlias",{get:function get(){return this.dialogRedirection.dialogProperties["dialogAlias"]},enumerable:true,configurable:true});PaneContext.prototype.findMenuDefAt=function(actionId){var result=null;this.menuDefs.some(function(md){result=md.findAtId(actionId);return result!=null});return result};PaneContext.prototype.formatForRead=function(propValue,propName){return PropFormatter.formatForRead(propValue,this.propDefAtName(propName))};PaneContext.prototype.formatForWrite=function(propValue,propName){return PropFormatter.formatForWrite(propValue,this.propDefAtName(propName))};Object.defineProperty(PaneContext.prototype,"formDef",{get:function get(){return this.parentContext.formDef},enumerable:true,configurable:true});Object.defineProperty(PaneContext.prototype,"isRefreshNeeded",{get:function get(){return this._lastRefreshTime.getTime()<AppContext.singleton.lastMaintenanceTime.getTime()},enumerable:true,configurable:true});Object.defineProperty(PaneContext.prototype,"lastRefreshTime",{get:function get(){return this._lastRefreshTime},set:function set(time){this._lastRefreshTime=time},enumerable:true,configurable:true});Object.defineProperty(PaneContext.prototype,"menuDefs",{get:function get(){return this.paneDef.menuDefs},enumerable:true,configurable:true});Object.defineProperty(PaneContext.prototype,"offlineCapable",{get:function get(){return this._parentContext&&this._parentContext.offlineCapable},enumerable:true,configurable:true});Object.defineProperty(PaneContext.prototype,"paneDef",{get:function get(){if(this.paneRef==null){return this.formDef.headerDef}else {return this.formDef.childrenDefs[this.paneRef]}},enumerable:true,configurable:true});Object.defineProperty(PaneContext.prototype,"paneRef",{get:function get(){return this._paneRef},enumerable:true,configurable:true});Object.defineProperty(PaneContext.prototype,"paneTitle",{get:function get(){return this.paneDef.findTitle()},enumerable:true,configurable:true});Object.defineProperty(PaneContext.prototype,"parentContext",{get:function get(){return this._parentContext},set:function set(parentContext){this._parentContext=parentContext},enumerable:true,configurable:true});PaneContext.prototype.parseValue=function(formattedValue,propName){return PropFormatter.parse(formattedValue,this.propDefAtName(propName))};PaneContext.prototype.propDefAtName=function(propName){return this.entityRecDef.propDefAtName(propName)};Object.defineProperty(PaneContext.prototype,"sessionContext",{get:function get(){return this.parentContext.sessionContext},enumerable:true,configurable:true});Object.defineProperty(PaneContext.prototype,"dialogRedirection",{ /** --------------------- MODULE ------------------------------*/ //*** let's pretend this has module level visibility
get:function get(){return this.paneDef.dialogRedirection},enumerable:true,configurable:true});PaneContext.ANNO_NAME_KEY="com.catavolt.annoName";PaneContext.PROP_NAME_KEY="com.catavolt.propName";return PaneContext})();exports.PaneContext=PaneContext; /**
 * *********************************
 */var EditorContext=(function(_super){__extends(EditorContext,_super);function EditorContext(paneRef){_super.call(this,paneRef)}Object.defineProperty(EditorContext.prototype,"buffer",{get:function get(){if(!this._buffer){this._buffer=new EntityBuffer(NullEntityRec.singleton)}return this._buffer},enumerable:true,configurable:true});EditorContext.prototype.changePaneMode=function(paneMode){var _this=this;return DialogService.changePaneMode(this.paneDef.dialogHandle,paneMode,this.sessionContext).bind(function(changePaneModeResult){_this.putSettings(changePaneModeResult.dialogProps);if(_this.isDestroyedSetting){_this._editorState=EditorState.DESTROYED}else {_this.entityRecDef=changePaneModeResult.entityRecDef;if(_this.isReadModeSetting){_this._editorState=EditorState.READ}else {_this._editorState=EditorState.WRITE}}return fp_3.Future.createSuccessfulFuture("EditorContext::changePaneMode",_this.entityRecDef)})};Object.defineProperty(EditorContext.prototype,"entityRec",{get:function get(){return this._buffer.toEntityRec()},enumerable:true,configurable:true});Object.defineProperty(EditorContext.prototype,"entityRecNow",{get:function get(){return this.entityRec},enumerable:true,configurable:true});Object.defineProperty(EditorContext.prototype,"entityRecDef",{get:function get(){return this._entityRecDef},set:function set(entityRecDef){this._entityRecDef=entityRecDef},enumerable:true,configurable:true});EditorContext.prototype.getAvailableValues=function(propName){return DialogService.getAvailableValues(this.paneDef.dialogHandle,propName,this.buffer.afterEffects(),this.sessionContext).map(function(valuesResult){return valuesResult.list})};EditorContext.prototype.isBinary=function(cellValueDef){var propDef=this.propDefAtName(cellValueDef.propertyName);return propDef&&(propDef.isBinaryType||propDef.isURLType&&cellValueDef.isInlineMediaStyle)};Object.defineProperty(EditorContext.prototype,"isDestroyed",{get:function get(){return this._editorState===EditorState.DESTROYED},enumerable:true,configurable:true});Object.defineProperty(EditorContext.prototype,"isReadMode",{get:function get(){return this._editorState===EditorState.READ},enumerable:true,configurable:true});EditorContext.prototype.isReadModeFor=function(propName){if(!this.isReadMode){var propDef=this.propDefAtName(propName);return !propDef||!propDef.maintainable||!propDef.writeEnabled}return true};Object.defineProperty(EditorContext.prototype,"isWriteMode",{get:function get(){return this._editorState===EditorState.WRITE},enumerable:true,configurable:true});EditorContext.prototype.performMenuAction=function(menuDef,pendingWrites){var _this=this;return DialogService.performEditorAction(this.paneDef.dialogHandle,menuDef.actionId,pendingWrites,this.sessionContext).bind(function(redirection){var ca=new ContextAction(menuDef.actionId,_this.parentContext.dialogRedirection.objectId,_this.actionSource);return NavRequestUtil.fromRedirection(redirection,ca,_this.sessionContext).map(function(navRequest){_this._settings=PaneContext.resolveSettingsFromNavRequest(_this._settings,navRequest);if(_this.isDestroyedSetting){_this._editorState=EditorState.DESTROYED}if(_this.isRefreshSetting){AppContext.singleton.lastMaintenanceTime=new Date}return navRequest})})};EditorContext.prototype.processSideEffects=function(propertyName,value){var _this=this;var sideEffectsFr=DialogService.processSideEffects(this.paneDef.dialogHandle,this.sessionContext,propertyName,value,this.buffer.afterEffects()).map(function(changeResult){return changeResult.sideEffects?changeResult.sideEffects.entityRec:new NullEntityRec});return sideEffectsFr.map(function(sideEffectsRec){var originalProps=_this.buffer.before.props;var userEffects=_this.buffer.afterEffects().props;var sideEffects=sideEffectsRec.props;sideEffects=sideEffects.filter(function(prop){return prop.name!==propertyName});_this._buffer=EntityBuffer.createEntityBuffer(_this.buffer.objectId,EntityRecUtil.union(originalProps,sideEffects),EntityRecUtil.union(originalProps,EntityRecUtil.union(userEffects,sideEffects)));return null})};EditorContext.prototype.read=function(){var _this=this;return DialogService.readEditorModel(this.paneDef.dialogHandle,this.sessionContext).map(function(readResult){_this.entityRecDef=readResult.entityRecDef;return readResult.entityRec}).map(function(entityRec){_this.initBuffer(entityRec);_this.lastRefreshTime=new Date;return entityRec})};EditorContext.prototype.requestedAccuracy=function(){var accuracyStr=this.paneDef.settings[EditorContext.GPS_ACCURACY];return accuracyStr?Number(accuracyStr):500};EditorContext.prototype.requestedTimeoutSeconds=function(){var timeoutStr=this.paneDef.settings[EditorContext.GPS_SECONDS];return timeoutStr?Number(timeoutStr):30};EditorContext.prototype.write=function(){var _this=this;var result=DialogService.writeEditorModel(this.paneDef.dialogRedirection.dialogHandle,this.buffer.afterEffects(),this.sessionContext).bind(function(either){if(either.isLeft){var ca=new ContextAction("#write",_this.parentContext.dialogRedirection.objectId,_this.actionSource);var navRequestFr=NavRequestUtil.fromRedirection(either.left,ca,_this.sessionContext).map(function(navRequest){return fp_2.Either.left(navRequest)})}else {var writeResult=either.right;_this.putSettings(writeResult.dialogProps);_this.entityRecDef=writeResult.entityRecDef;return fp_3.Future.createSuccessfulFuture("EditorContext::write",fp_2.Either.right(writeResult.entityRec))}});return result.map(function(successfulWrite){var now=new Date;AppContext.singleton.lastMaintenanceTime=now;_this.lastRefreshTime=now;if(successfulWrite.isLeft){_this._settings=PaneContext.resolveSettingsFromNavRequest(_this._settings,successfulWrite.left)}else {_this.initBuffer(successfulWrite.right)}if(_this.isDestroyedSetting){_this._editorState=EditorState.DESTROYED}else {if(_this.isReadModeSetting){_this._editorState=EditorState.READ}}return successfulWrite})}; //Module level methods
EditorContext.prototype.initialize=function(){this._entityRecDef=this.paneDef.entityRecDef;this._settings=util_2.ObjUtil.addAllProps(this.dialogRedirection.dialogProperties,{});this._editorState=this.isReadModeSetting?EditorState.READ:EditorState.WRITE};Object.defineProperty(EditorContext.prototype,"settings",{get:function get(){return this._settings},enumerable:true,configurable:true}); //Private methods
EditorContext.prototype.initBuffer=function(entityRec){this._buffer=entityRec?new EntityBuffer(entityRec):new EntityBuffer(NullEntityRec.singleton)};Object.defineProperty(EditorContext.prototype,"isDestroyedSetting",{get:function get(){var str=this._settings["destroyed"];return str&&str.toLowerCase()==="true"},enumerable:true,configurable:true});Object.defineProperty(EditorContext.prototype,"isGlobalRefreshSetting",{get:function get(){var str=this._settings["globalRefresh"];return str&&str.toLowerCase()==="true"},enumerable:true,configurable:true});Object.defineProperty(EditorContext.prototype,"isLocalRefreshSetting",{get:function get(){var str=this._settings["localRefresh"];return str&&str.toLowerCase()==="true"},enumerable:true,configurable:true});Object.defineProperty(EditorContext.prototype,"isReadModeSetting",{get:function get(){var paneMode=this.paneModeSetting;return paneMode&&paneMode.toLowerCase()==="read"},enumerable:true,configurable:true});Object.defineProperty(EditorContext.prototype,"isRefreshSetting",{get:function get(){return this.isLocalRefreshSetting||this.isGlobalRefreshSetting},enumerable:true,configurable:true});Object.defineProperty(EditorContext.prototype,"paneModeSetting",{get:function get(){return this._settings["paneMode"]},enumerable:true,configurable:true});EditorContext.prototype.putSetting=function(key,value){this._settings[key]=value};EditorContext.prototype.putSettings=function(settings){util_2.ObjUtil.addAllProps(settings,this._settings)};EditorContext.GPS_ACCURACY="com.catavolt.core.domain.GeoFix.accuracy";EditorContext.GPS_SECONDS="com.catavolt.core.domain.GeoFix.seconds";return EditorContext})(PaneContext);exports.EditorContext=EditorContext; /**
 * *********************************
 */var FormContext=(function(_super){__extends(FormContext,_super);function FormContext(_dialogRedirection,_actionSource,_formDef,_childrenContexts,_offlineCapable,_offlineData,_sessionContext){var _this=this;_super.call(this,null);this._dialogRedirection=_dialogRedirection;this._actionSource=_actionSource;this._formDef=_formDef;this._childrenContexts=_childrenContexts;this._offlineCapable=_offlineCapable;this._offlineData=_offlineData;this._sessionContext=_sessionContext;this._destroyed=false;this._offlineProps={};this._childrenContexts=_childrenContexts||[];this._childrenContexts.forEach(function(c){c.parentContext=_this})}Object.defineProperty(FormContext.prototype,"actionSource",{get:function get(){return this.parentContext?this.parentContext.actionSource:this._actionSource},enumerable:true,configurable:true});Object.defineProperty(FormContext.prototype,"childrenContexts",{get:function get(){return this._childrenContexts},enumerable:true,configurable:true});FormContext.prototype.close=function(){return DialogService.closeEditorModel(this.dialogRedirection.dialogHandle,this.sessionContext)};Object.defineProperty(FormContext.prototype,"dialogRedirection",{get:function get(){return this._dialogRedirection},enumerable:true,configurable:true});Object.defineProperty(FormContext.prototype,"entityRecDef",{get:function get(){return this.formDef.entityRecDef},enumerable:true,configurable:true});Object.defineProperty(FormContext.prototype,"formDef",{get:function get(){return this._formDef},enumerable:true,configurable:true});Object.defineProperty(FormContext.prototype,"headerContext",{get:function get(){throw new Error("FormContext::headerContext: Needs Impl")},enumerable:true,configurable:true});FormContext.prototype.performMenuAction=function(menuDef){var _this=this;return DialogService.performEditorAction(this.paneDef.dialogHandle,menuDef.actionId,NullEntityRec.singleton,this.sessionContext).bind(function(value){var destroyedStr=value.fromDialogProperties["destroyed"];if(destroyedStr&&destroyedStr.toLowerCase()==="true"){_this._destroyed=true}var ca=new ContextAction(menuDef.actionId,_this.dialogRedirection.objectId,_this.actionSource);return NavRequestUtil.fromRedirection(value,ca,_this.sessionContext)})};Object.defineProperty(FormContext.prototype,"isDestroyed",{get:function get(){return this._destroyed||this.isAnyChildDestroyed},enumerable:true,configurable:true});Object.defineProperty(FormContext.prototype,"offlineCapable",{get:function get(){return this._offlineCapable},enumerable:true,configurable:true});Object.defineProperty(FormContext.prototype,"menuDefs",{get:function get(){return this.formDef.menuDefs},enumerable:true,configurable:true});Object.defineProperty(FormContext.prototype,"offlineProps",{get:function get(){return this._offlineProps},enumerable:true,configurable:true});Object.defineProperty(FormContext.prototype,"paneDef",{get:function get(){return this.formDef},enumerable:true,configurable:true});Object.defineProperty(FormContext.prototype,"sessionContext",{get:function get(){return this._sessionContext},enumerable:true,configurable:true});Object.defineProperty(FormContext.prototype,"isAnyChildDestroyed",{ /** --------------------- MODULE ------------------------------*/ //*** let's pretend this has module level visibility (no such thing (yet!))
get:function get(){return this.childrenContexts.some(function(paneContext){if(paneContext instanceof EditorContext||paneContext instanceof QueryContext){return paneContext.isDestroyed}return false})},enumerable:true,configurable:true});FormContext.prototype.processNavRequestForDestroyed=function(navRequest){var fromDialogProps={};if(navRequest instanceof FormContext){fromDialogProps=navRequest.offlineProps}else if(navRequest instanceof NullNavRequest){fromDialogProps=navRequest.fromDialogProperties}var destroyedStr=fromDialogProps["destroyed"];if(destroyedStr&&destroyedStr.toLowerCase()==="true"){this._destroyed=true}var fromDialogDestroyed=fromDialogProps["fromDialogDestroyed"];if(fromDialogDestroyed){this._destroyed=true}};return FormContext})(PaneContext);exports.FormContext=FormContext; /**
 * *********************************
 */var QueryState;(function(QueryState){QueryState[QueryState["ACTIVE"]=0]="ACTIVE";QueryState[QueryState["DESTROYED"]=1]="DESTROYED"})(QueryState||(QueryState={}));(function(QueryDirection){QueryDirection[QueryDirection["FORWARD"]=0]="FORWARD";QueryDirection[QueryDirection["BACKWARD"]=1]="BACKWARD"})(exports.QueryDirection||(exports.QueryDirection={}));var QueryDirection=exports.QueryDirection;var QueryContext=(function(_super){__extends(QueryContext,_super);function QueryContext(paneRef,_offlineRecs,_settings){if(_offlineRecs===void 0){_offlineRecs=[]}if(_settings===void 0){_settings={}}_super.call(this,paneRef);this._offlineRecs=_offlineRecs;this._settings=_settings}Object.defineProperty(QueryContext.prototype,"entityRecDef",{get:function get(){return this.paneDef.entityRecDef},enumerable:true,configurable:true});QueryContext.prototype.isBinary=function(columnDef){var propDef=this.propDefAtName(columnDef.name);return propDef&&(propDef.isBinaryType||propDef.isURLType&&columnDef.isInlineMediaStyle)};Object.defineProperty(QueryContext.prototype,"isDestroyed",{get:function get(){return this._queryState===QueryState.DESTROYED},enumerable:true,configurable:true});Object.defineProperty(QueryContext.prototype,"lastQueryFr",{get:function get(){return this._lastQueryFr},enumerable:true,configurable:true});Object.defineProperty(QueryContext.prototype,"offlineRecs",{get:function get(){return this._offlineRecs},set:function set(offlineRecs){this._offlineRecs=offlineRecs},enumerable:true,configurable:true});Object.defineProperty(QueryContext.prototype,"paneMode",{get:function get(){return this._settings["paneMode"]},enumerable:true,configurable:true});QueryContext.prototype.performMenuAction=function(menuDef,targets){var _this=this;return DialogService.performQueryAction(this.paneDef.dialogHandle,menuDef.actionId,targets,this.sessionContext).bind(function(redirection){var target=targets.length>0?targets[0]:null;var ca=new ContextAction(menuDef.actionId,target,_this.actionSource);return NavRequestUtil.fromRedirection(redirection,ca,_this.sessionContext)}).map(function(navRequest){_this._settings=PaneContext.resolveSettingsFromNavRequest(_this._settings,navRequest);if(_this.isDestroyedSetting){_this._queryState=QueryState.DESTROYED}return navRequest})};QueryContext.prototype.query=function(maxRows,direction,fromObjectId){var _this=this;return DialogService.queryQueryModel(this.paneDef.dialogHandle,direction,maxRows,fromObjectId,this.sessionContext).bind(function(value){var result=new QueryResult(value.entityRecs,value.hasMore);if(_this.lastRefreshTime===new Date(0)){_this.lastRefreshTime=new Date}return fp_3.Future.createSuccessfulFuture("QueryContext::query",result)})};QueryContext.prototype.refresh=function(){return this._scroller.refresh()};Object.defineProperty(QueryContext.prototype,"scroller",{get:function get(){if(!this._scroller){this._scroller=this.newScroller()}return this._scroller},enumerable:true,configurable:true});QueryContext.prototype.setScroller=function(pageSize,firstObjectId,markerOptions){this._scroller=new QueryScroller(this,pageSize,firstObjectId,markerOptions);return this._scroller}; //module level methods
QueryContext.prototype.newScroller=function(){return this.setScroller(50,null,[QueryMarkerOption.None])};QueryContext.prototype.settings=function(){return this._settings};Object.defineProperty(QueryContext.prototype,"isDestroyedSetting",{get:function get(){var str=this._settings["destroyed"];return str&&str.toLowerCase()==="true"},enumerable:true,configurable:true});Object.defineProperty(QueryContext.prototype,"isGlobalRefreshSetting",{get:function get(){var str=this._settings["globalRefresh"];return str&&str.toLowerCase()==="true"},enumerable:true,configurable:true});Object.defineProperty(QueryContext.prototype,"isLocalRefreshSetting",{get:function get(){var str=this._settings["localRefresh"];return str&&str.toLowerCase()==="true"},enumerable:true,configurable:true});Object.defineProperty(QueryContext.prototype,"isRefreshSetting",{get:function get(){return this.isLocalRefreshSetting||this.isGlobalRefreshSetting},enumerable:true,configurable:true});return QueryContext})(PaneContext);exports.QueryContext=QueryContext; /**
 * *********************************
 ...
 * *********************************
 */var AppContextState;(function(AppContextState){AppContextState[AppContextState["LOGGED_OUT"]=0]="LOGGED_OUT";AppContextState[AppContextState["LOGGED_IN"]=1]="LOGGED_IN"})(AppContextState||(AppContextState={}));var AppContextValues=(function(){function AppContextValues(sessionContext,appWinDef,tenantSettings){this.sessionContext=sessionContext;this.appWinDef=appWinDef;this.tenantSettings=tenantSettings}return AppContextValues})();var AppContext=(function(){function AppContext(){if(AppContext._singleton){throw new Error("Singleton instance already created")}this._deviceProps=[];this.setAppContextStateToLoggedOut();AppContext._singleton=this}Object.defineProperty(AppContext,"defaultTTLInMillis",{get:function get(){return AppContext.ONE_DAY_IN_MILLIS},enumerable:true,configurable:true});Object.defineProperty(AppContext,"singleton",{get:function get(){if(!AppContext._singleton){AppContext._singleton=new AppContext}return AppContext._singleton},enumerable:true,configurable:true});Object.defineProperty(AppContext.prototype,"appWinDefTry",{get:function get(){return this._appWinDefTry},enumerable:true,configurable:true});Object.defineProperty(AppContext.prototype,"deviceProps",{get:function get(){return this._deviceProps},enumerable:true,configurable:true});Object.defineProperty(AppContext.prototype,"isLoggedIn",{get:function get(){return this._appContextState===AppContextState.LOGGED_IN},enumerable:true,configurable:true});AppContext.prototype.getWorkbench=function(sessionContext,workbenchId){if(this._appContextState===AppContextState.LOGGED_OUT){return fp_3.Future.createFailedFuture("AppContext::getWorkbench","User is logged out")}return WorkbenchService.getWorkbench(sessionContext,workbenchId)};AppContext.prototype.login=function(gatewayHost,tenantId,clientType,userId,password){var _this=this;if(this._appContextState===AppContextState.LOGGED_IN){return fp_3.Future.createFailedFuture("AppContext::login","User is already logged in")}var answer;var appContextValuesFr=this.loginOnline(gatewayHost,tenantId,clientType,userId,password,this.deviceProps);return appContextValuesFr.bind(function(appContextValues){_this.setAppContextStateToLoggedIn(appContextValues);return fp_3.Future.createSuccessfulFuture("AppContext::login",appContextValues.appWinDef)})};AppContext.prototype.loginDirectly=function(url,tenantId,clientType,userId,password){var _this=this;if(this._appContextState===AppContextState.LOGGED_IN){return fp_3.Future.createFailedFuture("AppContext::loginDirectly","User is already logged in")}return this.loginFromSystemContext(new SystemContextImpl(url),tenantId,userId,password,this.deviceProps,clientType).bind(function(appContextValues){_this.setAppContextStateToLoggedIn(appContextValues);return fp_3.Future.createSuccessfulFuture("AppContext::loginDirectly",appContextValues.appWinDef)})};AppContext.prototype.logout=function(){if(this._appContextState===AppContextState.LOGGED_OUT){return fp_3.Future.createFailedFuture("AppContext::loginDirectly","User is already logged out")}var result=SessionService.deleteSession(this.sessionContextTry.success);result.onComplete(function(deleteSessionTry){if(deleteSessionTry.isFailure){util_1.Log.error("Error while logging out: "+util_2.ObjUtil.formatRecAttr(deleteSessionTry.failure))}});this.setAppContextStateToLoggedOut();return result};AppContext.prototype.performLaunchAction=function(launchAction){if(this._appContextState===AppContextState.LOGGED_OUT){return fp_3.Future.createFailedFuture("AppContext::performLaunchAction","User is logged out")}return this.performLaunchActionOnline(launchAction,this.sessionContextTry.success)};AppContext.prototype.refreshContext=function(sessionContext,deviceProps){var _this=this;if(deviceProps===void 0){deviceProps=[]}var appContextValuesFr=this.finalizeContext(sessionContext,deviceProps);return appContextValuesFr.bind(function(appContextValues){_this.setAppContextStateToLoggedIn(appContextValues);return fp_3.Future.createSuccessfulFuture("AppContext::login",appContextValues.appWinDef)})};Object.defineProperty(AppContext.prototype,"sessionContextTry",{get:function get(){return this._sessionContextTry},enumerable:true,configurable:true});Object.defineProperty(AppContext.prototype,"tenantSettingsTry",{get:function get(){return this._tenantSettingsTry},enumerable:true,configurable:true});AppContext.prototype.finalizeContext=function(sessionContext,deviceProps){var devicePropName="com.catavolt.session.property.DeviceProperties";return SessionService.setSessionListProperty(devicePropName,deviceProps,sessionContext).bind(function(setPropertyListResult){var listPropName="com.catavolt.session.property.TenantProperties";return SessionService.getSessionListProperty(listPropName,sessionContext).bind(function(listPropertyResult){return WorkbenchService.getAppWinDef(sessionContext).bind(function(appWinDef){return fp_3.Future.createSuccessfulFuture("AppContextCore:loginFromSystemContext",new AppContextValues(sessionContext,appWinDef,listPropertyResult.valuesAsDictionary()))})})})};AppContext.prototype.loginOnline=function(gatewayHost,tenantId,clientType,userId,password,deviceProps){var _this=this;var systemContextFr=this.newSystemContextFr(gatewayHost,tenantId);return systemContextFr.bind(function(sc){return _this.loginFromSystemContext(sc,tenantId,userId,password,deviceProps,clientType)})};AppContext.prototype.loginFromSystemContext=function(systemContext,tenantId,userId,password,deviceProps,clientType){var _this=this;var sessionContextFuture=SessionService.createSession(tenantId,userId,password,clientType,systemContext);return sessionContextFuture.bind(function(sessionContext){return _this.finalizeContext(sessionContext,deviceProps)})};AppContext.prototype.newSystemContextFr=function(gatewayHost,tenantId){var serviceEndpoint=GatewayService.getServiceEndpoint(tenantId,"soi-json",gatewayHost);return serviceEndpoint.map(function(serviceEndpoint){return new SystemContextImpl(serviceEndpoint.serverAssignment)})};AppContext.prototype.performLaunchActionOnline=function(launchAction,sessionContext){var redirFr=WorkbenchService.performLaunchAction(launchAction.id,launchAction.workbenchId,sessionContext);return redirFr.bind(function(r){return NavRequestUtil.fromRedirection(r,launchAction,sessionContext)})};AppContext.prototype.setAppContextStateToLoggedIn=function(appContextValues){this._appWinDefTry=new fp_4.Success(appContextValues.appWinDef);this._tenantSettingsTry=new fp_4.Success(appContextValues.tenantSettings);this._sessionContextTry=new fp_4.Success(appContextValues.sessionContext);this._appContextState=AppContextState.LOGGED_IN};AppContext.prototype.setAppContextStateToLoggedOut=function(){this._appWinDefTry=new fp_5.Failure("Not logged in");this._tenantSettingsTry=new fp_5.Failure("Not logged in\"");this._sessionContextTry=new fp_5.Failure("Not loggged in");this._appContextState=AppContextState.LOGGED_OUT};AppContext.ONE_DAY_IN_MILLIS=60*60*24*1000;return AppContext})();exports.AppContext=AppContext; /**
 * *********************************
 */var AppWinDef=(function(){function AppWinDef(workbenches,appVendors,windowTitle,windowWidth,windowHeight){this._workbenches=workbenches||[];this._applicationVendors=appVendors||[];this._windowTitle=windowTitle;this._windowWidth=windowWidth;this._windowHeight=windowHeight}Object.defineProperty(AppWinDef.prototype,"appVendors",{get:function get(){return this._applicationVendors},enumerable:true,configurable:true});Object.defineProperty(AppWinDef.prototype,"windowHeight",{get:function get(){return this._windowHeight},enumerable:true,configurable:true});Object.defineProperty(AppWinDef.prototype,"windowTitle",{get:function get(){return this._windowTitle},enumerable:true,configurable:true});Object.defineProperty(AppWinDef.prototype,"windowWidth",{get:function get(){return this._windowWidth},enumerable:true,configurable:true});Object.defineProperty(AppWinDef.prototype,"workbenches",{get:function get(){return this._workbenches},enumerable:true,configurable:true});return AppWinDef})();exports.AppWinDef=AppWinDef; /**
 * *********************************
 */ /*
 @TODO
 ...
 * *********************************
 */var DialogService=(function(){function DialogService(){}DialogService.changePaneMode=function(dialogHandle,paneMode,sessionContext){var method="changePaneMode";var params={"dialogHandle":OType.serializeObject(dialogHandle,"WSDialogHandle"),"paneMode":PaneMode[paneMode]};var call=ws_1.Call.createCall(DialogService.EDITOR_SERVICE_PATH,method,params,sessionContext);return call.perform().bind(function(result){return fp_3.Future.createCompletedFuture("changePaneMode",DialogTriple.fromWSDialogObject(result,"WSChangePaneModeResult",OType.factoryFn))})};DialogService.closeEditorModel=function(dialogHandle,sessionContext){var method="close";var params={"dialogHandle":OType.serializeObject(dialogHandle,"WSDialogHandle")};var call=ws_1.Call.createCall(DialogService.EDITOR_SERVICE_PATH,method,params,sessionContext);return call.perform().bind(function(result){return fp_3.Future.createSuccessfulFuture("closeEditorModel",result)})};DialogService.getAvailableValues=function(dialogHandle,propertyName,pendingWrites,sessionContext){var method="getAvailableValues";var params={"dialogHandle":OType.serializeObject(dialogHandle,"WSDialogHandle"),"propertyName":propertyName};if(pendingWrites)params["pendingWrites"]=pendingWrites.toWSEditorRecord();var call=ws_1.Call.createCall(DialogService.EDITOR_SERVICE_PATH,method,params,sessionContext);return call.perform().bind(function(result){return fp_3.Future.createCompletedFuture("getAvailableValues",DialogTriple.fromWSDialogObject(result,"WSGetAvailableValuesResult",OType.factoryFn))})};DialogService.getActiveColumnDefs=function(dialogHandle,sessionContext){var method="getActiveColumnDefs";var params={"dialogHandle":OType.serializeObject(dialogHandle,"WSDialogHandle")};var call=ws_1.Call.createCall(DialogService.QUERY_SERVICE_PATH,method,params,sessionContext);return call.perform().bind(function(result){return fp_3.Future.createCompletedFuture("getActiveColumnDefs",DialogTriple.fromWSDialogObject(result,"WSGetActiveColumnDefsResult",OType.factoryFn))})};DialogService.getEditorModelMenuDefs=function(dialogHandle,sessionContext){var method="getMenuDefs";var params={"dialogHandle":OType.serializeObject(dialogHandle,"WSDialogHandle")};var call=ws_1.Call.createCall(DialogService.EDITOR_SERVICE_PATH,method,params,sessionContext);return call.perform().bind(function(result){return fp_3.Future.createCompletedFuture("getEditorModelMenuDefs",DialogTriple.fromWSDialogObjectsResult(result,"WSGetMenuDefsResult","WSMenuDef","menuDefs",OType.factoryFn))})};DialogService.getEditorModelPaneDef=function(dialogHandle,paneId,sessionContext){var method="getPaneDef";var params={"dialogHandle":OType.serializeObject(dialogHandle,"WSDialogHandle")};params["paneId"]=paneId;var call=ws_1.Call.createCall(DialogService.EDITOR_SERVICE_PATH,method,params,sessionContext);return call.perform().bind(function(result){return fp_3.Future.createCompletedFuture("getEditorModelPaneDef",DialogTriple.fromWSDialogObjectResult(result,"WSGetPaneDefResult","WSPaneDef","paneDef",OType.factoryFn))})};DialogService.getQueryModelMenuDefs=function(dialogHandle,sessionContext){var method="getMenuDefs";var params={"dialogHandle":OType.serializeObject(dialogHandle,"WSDialogHandle")};var call=ws_1.Call.createCall(DialogService.QUERY_SERVICE_PATH,method,params,sessionContext);return call.perform().bind(function(result){return fp_3.Future.createCompletedFuture("getQueryModelMenuDefs",DialogTriple.fromWSDialogObjectsResult(result,"WSGetMenuDefsResult","WSMenuDef","menuDefs",OType.factoryFn))})};DialogService.openEditorModelFromRedir=function(redirection,sessionContext){var method="open2";var params={"editorMode":redirection.dialogMode,"dialogHandle":OType.serializeObject(redirection.dialogHandle,"WSDialogHandle")};if(redirection.objectId)params["objectId"]=redirection.objectId;var call=ws_1.Call.createCall(DialogService.EDITOR_SERVICE_PATH,method,params,sessionContext);return call.perform().bind(function(result){return fp_3.Future.createCompletedFuture("openEditorModelFromRedir",DialogTriple.fromWSDialogObject(result,"WSOpenEditorModelResult",OType.factoryFn))})};DialogService.openQueryModelFromRedir=function(redirection,sessionContext){if(!redirection.isQuery)return fp_3.Future.createFailedFuture("DialogService::openQueryModelFromRedir","Redirection must be a query");var method="open";var params={"dialogHandle":OType.serializeObject(redirection.dialogHandle,"WSDialogHandle")};var call=ws_1.Call.createCall(DialogService.QUERY_SERVICE_PATH,method,params,sessionContext);return call.perform().bind(function(result){return fp_3.Future.createCompletedFuture("openQueryModelFromRedir",DialogTriple.fromWSDialogObject(result,"WSOpenQueryModelResult",OType.factoryFn))})};DialogService.performEditorAction=function(dialogHandle,actionId,pendingWrites,sessionContext){var method="performAction";var params={"actionId":actionId,"dialogHandle":OType.serializeObject(dialogHandle,"WSDialogHandle")};if(pendingWrites)params["pendingWrites"]=pendingWrites.toWSEditorRecord();var call=ws_1.Call.createCall(DialogService.EDITOR_SERVICE_PATH,method,params,sessionContext);return call.perform().bind(function(result){var redirectionTry=DialogTriple.extractRedirection(result,"WSPerformActionResult");if(redirectionTry.isSuccess){var r=redirectionTry.success;r.fromDialogProperties=result["dialogProperties"];redirectionTry=new fp_4.Success(r)}return fp_3.Future.createCompletedFuture("performEditorAction",redirectionTry)})};DialogService.performQueryAction=function(dialogHandle,actionId,targets,sessionContext){var method="performAction";var params={"actionId":actionId,"dialogHandle":OType.serializeObject(dialogHandle,"WSDialogHandle")};if(targets){params["targets"]=targets}var call=ws_1.Call.createCall(DialogService.QUERY_SERVICE_PATH,method,params,sessionContext);return call.perform().bind(function(result){var redirectionTry=DialogTriple.extractRedirection(result,"WSPerformActionResult");if(redirectionTry.isSuccess){var r=redirectionTry.success;r.fromDialogProperties=result["dialogProperties"];redirectionTry=new fp_4.Success(r)}return fp_3.Future.createCompletedFuture("performQueryAction",redirectionTry)})};DialogService.processSideEffects=function(dialogHandle,sessionContext,propertyName,propertyValue,pendingWrites){var method="handlePropertyChange";var params={"dialogHandle":OType.serializeObject(dialogHandle,"WSDialogHandle"),"propertyName":propertyName,"propertyValue":Prop.toWSProperty(propertyValue),"pendingWrites":pendingWrites.toWSEditorRecord()};var call=ws_1.Call.createCall(DialogService.EDITOR_SERVICE_PATH,method,params,sessionContext);return call.perform().bind(function(result){return fp_3.Future.createCompletedFuture("processSideEffects",DialogTriple.fromWSDialogObject(result,"WSHandlePropertyChangeResult",OType.factoryFn))})};DialogService.queryQueryModel=function(dialogHandle,direction,maxRows,fromObjectId,sessionContext){var method="query";var params={"dialogHandle":OType.serializeObject(dialogHandle,"WSDialogHandle"),"maxRows":maxRows,"direction":direction===QueryDirection.BACKWARD?"BACKWARD":"FORWARD"};if(fromObjectId&&fromObjectId.trim()!==""){params["fromObjectId"]=fromObjectId.trim()}util_1.Log.info("Running query");var call=ws_1.Call.createCall(DialogService.QUERY_SERVICE_PATH,method,params,sessionContext);return call.perform().bind(function(result){var call=ws_1.Call.createCall(DialogService.QUERY_SERVICE_PATH,method,params,sessionContext);return fp_3.Future.createCompletedFuture("DialogService::queryQueryModel",DialogTriple.fromWSDialogObject(result,"WSQueryResult",OType.factoryFn))})};DialogService.readEditorModel=function(dialogHandle,sessionContext){var method="read";var params={"dialogHandle":OType.serializeObject(dialogHandle,"WSDialogHandle")};var call=ws_1.Call.createCall(DialogService.EDITOR_SERVICE_PATH,method,params,sessionContext);return call.perform().bind(function(result){return fp_3.Future.createCompletedFuture("readEditorModel",DialogTriple.fromWSDialogObject(result,"WSReadResult",OType.factoryFn))})};DialogService.writeEditorModel=function(dialogHandle,entityRec,sessionContext){var method="write";var params={"dialogHandle":OType.serializeObject(dialogHandle,"WSDialogHandle"),"editorRecord":entityRec.toWSEditorRecord()};var call=ws_1.Call.createCall(DialogService.EDITOR_SERVICE_PATH,method,params,sessionContext);return call.perform().bind(function(result){var writeResultTry=DialogTriple.fromWSDialogObject(result,"WSWriteResult",OType.factoryFn);if(writeResultTry.isSuccess&&writeResultTry.success.isLeft){var redirection=writeResultTry.success.left;redirection.fromDialogProperties=result["dialogProperties"]||{};writeResultTry=new fp_4.Success(fp_2.Either.left(redirection))}return fp_3.Future.createCompletedFuture("writeEditorModel",writeResultTry)})};DialogService.EDITOR_SERVICE_NAME="EditorService";DialogService.EDITOR_SERVICE_PATH="soi-json-v02/"+DialogService.EDITOR_SERVICE_NAME;DialogService.QUERY_SERVICE_NAME="QueryService";DialogService.QUERY_SERVICE_PATH="soi-json-v02/"+DialogService.QUERY_SERVICE_NAME;return DialogService})();exports.DialogService=DialogService; /**
 * *********************************
 */var DialogTriple=(function(){function DialogTriple(){}DialogTriple.extractList=function(jsonObject,Ltype,extractor){var result;if(jsonObject){var lt=jsonObject["WS_LTYPE"];if(Ltype===lt){if(jsonObject["values"]){var realValues=[];var values=jsonObject["values"];values.every(function(item){var extdValue=extractor(item);if(extdValue.isFailure){result=new fp_5.Failure(extdValue.failure);return false}realValues.push(extdValue.success);return true});if(!result){result=new fp_4.Success(realValues)}}else {result=new fp_5.Failure("DialogTriple::extractList: Values array not found")}}else {result=new fp_5.Failure("DialogTriple::extractList: Expected WS_LTYPE "+Ltype+" but found "+lt)}}return result};DialogTriple.extractRedirection=function(jsonObject,Otype){var tripleTry=DialogTriple._extractTriple(jsonObject,Otype,false,function(){return new fp_4.Success(new NullRedirection({}))});var answer;if(tripleTry.isSuccess){var triple=tripleTry.success;answer=triple.isLeft?new fp_4.Success(triple.left):new fp_4.Success(triple.right)}else {answer=new fp_5.Failure(tripleTry.failure)}return answer};DialogTriple.extractTriple=function(jsonObject,Otype,extractor){return DialogTriple._extractTriple(jsonObject,Otype,false,extractor)};DialogTriple.extractValue=function(jsonObject,Otype,extractor){return DialogTriple._extractValue(jsonObject,Otype,false,extractor)};DialogTriple.extractValueIgnoringRedirection=function(jsonObject,Otype,extractor){return DialogTriple._extractValue(jsonObject,Otype,true,extractor)};DialogTriple.fromWSDialogObject=function(obj,Otype,factoryFn,ignoreRedirection){if(ignoreRedirection===void 0){ignoreRedirection=false}if(!obj){return new fp_5.Failure("DialogTriple::fromWSDialogObject: Cannot extract from null value")}else if((typeof obj==="undefined"?"undefined":_typeof(obj))!=="object"){return new fp_4.Success(obj)}try{if(!factoryFn){ /* Assume we're just going to coerce the exiting object */return DialogTriple.extractValue(obj,Otype,function(){return new fp_4.Success(obj)})}else {if(ignoreRedirection){return DialogTriple.extractValueIgnoringRedirection(obj,Otype,function(){return OType.deserializeObject(obj,Otype,factoryFn)})}else {return DialogTriple.extractValue(obj,Otype,function(){return OType.deserializeObject(obj,Otype,factoryFn)})}}}catch(e) {return new fp_5.Failure("DialogTriple::fromWSDialogObject: "+e.name+": "+e.message)}};DialogTriple.fromListOfWSDialogObject=function(jsonObject,Ltype,factoryFn,ignoreRedirection){if(ignoreRedirection===void 0){ignoreRedirection=false}return DialogTriple.extractList(jsonObject,Ltype,function(value){ /*note - we could add a check here to make sure the otype 'is a' ltype, to enforce the generic constraint
             i.e. list items should be lype assignment compatible*/if(!value)return new fp_4.Success(null);var Otype=value["WS_OTYPE"]||Ltype;return DialogTriple.fromWSDialogObject(value,Otype,factoryFn,ignoreRedirection)})};DialogTriple.fromWSDialogObjectResult=function(jsonObject,resultOtype,targetOtype,objPropName,factoryFn){return DialogTriple.extractValue(jsonObject,resultOtype,function(){return DialogTriple.fromWSDialogObject(jsonObject[objPropName],targetOtype,factoryFn)})};DialogTriple.fromWSDialogObjectsResult=function(jsonObject,resultOtype,targetLtype,objPropName,factoryFn){return DialogTriple.extractValue(jsonObject,resultOtype,function(){return DialogTriple.fromListOfWSDialogObject(jsonObject[objPropName],targetLtype,factoryFn)})};DialogTriple._extractTriple=function(jsonObject,Otype,ignoreRedirection,extractor){if(!jsonObject){return new fp_5.Failure("DialogTriple::extractTriple: cannot extract object of WS_OTYPE "+Otype+" because json object is null")}else {if(Array.isArray(jsonObject)){ //verify we'll dealing with a nested List
if(Otype.indexOf("List")!==0){return new fp_5.Failure("DialogTriple::extractTriple: expected OType of List<> for Array obj")}}else {var ot=jsonObject["WS_OTYPE"];if(!ot||Otype!==ot){return new fp_5.Failure("DialogTriple:extractTriple: expected O_TYPE "+Otype+" but found "+ot)}else {if(jsonObject["exception"]){var dialogException=jsonObject["exception"];return new fp_5.Failure(dialogException)}else if(jsonObject["redirection"]&&!ignoreRedirection){var drt=DialogTriple.fromWSDialogObject(jsonObject["redirection"],"WSRedirection",OType.factoryFn);if(drt.isFailure){return new fp_5.Failure(drt.failure)}else {var either=fp_2.Either.left(drt.success);return new fp_4.Success(either)}}}}var result;if(extractor){var valueTry=extractor();if(valueTry.isFailure){result=new fp_5.Failure(valueTry.failure)}else {result=new fp_4.Success(fp_2.Either.right(valueTry.success))}}else {result=new fp_5.Failure("DialogTriple::extractTriple: Triple is not an exception or redirection and no value extractor was provided")}return result}};DialogTriple._extractValue=function(jsonObject,Otype,ignoreRedirection,extractor){var tripleTry=DialogTriple._extractTriple(jsonObject,Otype,ignoreRedirection,extractor);var result;if(tripleTry.isFailure){result=new fp_5.Failure(tripleTry.failure)}else {var triple=tripleTry.success;if(triple.isLeft){result=new fp_5.Failure("DialogTriple::extractValue: Unexpected redirection for O_TYPE: "+Otype)}else {result=new fp_4.Success(triple.right)}}return result};return DialogTriple})();exports.DialogTriple=DialogTriple; /**
 * *********************************
 ...
 * *********************************
 */var FormContextBuilder=(function(){function FormContextBuilder(_dialogRedirection,_actionSource,_sessionContext){this._dialogRedirection=_dialogRedirection;this._actionSource=_actionSource;this._sessionContext=_sessionContext}Object.defineProperty(FormContextBuilder.prototype,"actionSource",{get:function get(){return this._actionSource},enumerable:true,configurable:true});FormContextBuilder.prototype.build=function(){var _this=this;if(!this.dialogRedirection.isEditor){return fp_3.Future.createFailedFuture("FormContextBuilder::build","Forms with a root query model are not supported")}var xOpenFr=DialogService.openEditorModelFromRedir(this._dialogRedirection,this.sessionContext);var openAllFr=xOpenFr.bind(function(formXOpen){var formXOpenFr=fp_3.Future.createSuccessfulFuture("FormContext/open/openForm",formXOpen);var formXFormDefFr=_this.fetchXFormDef(formXOpen);var formMenuDefsFr=DialogService.getEditorModelMenuDefs(formXOpen.formRedirection.dialogHandle,_this.sessionContext);var formChildrenFr=formXFormDefFr.bind(function(xFormDef){var childrenXOpenFr=_this.openChildren(formXOpen);var childrenXPaneDefsFr=_this.fetchChildrenXPaneDefs(formXOpen,xFormDef);var childrenActiveColDefsFr=_this.fetchChildrenActiveColDefs(formXOpen);var childrenMenuDefsFr=_this.fetchChildrenMenuDefs(formXOpen);return fp_3.Future.sequence([childrenXOpenFr,childrenXPaneDefsFr,childrenActiveColDefsFr,childrenMenuDefsFr])});return fp_3.Future.sequence([formXOpenFr,formXFormDefFr,formMenuDefsFr,formChildrenFr])});return openAllFr.bind(function(value){var formDefTry=_this.completeOpenPromise(value);var formContextTry=null;if(formDefTry.isFailure){formContextTry=new fp_5.Failure(formDefTry.failure)}else {var formDef=formDefTry.success;var childContexts=_this.createChildrenContexts(formDef);var formContext=new FormContext(_this.dialogRedirection,_this._actionSource,formDef,childContexts,false,false,_this.sessionContext);formContextTry=new fp_4.Success(formContext)}return fp_3.Future.createCompletedFuture("FormContextBuilder::build",formContextTry)})};Object.defineProperty(FormContextBuilder.prototype,"dialogRedirection",{get:function get(){return this._dialogRedirection},enumerable:true,configurable:true});Object.defineProperty(FormContextBuilder.prototype,"sessionContext",{get:function get(){return this._sessionContext},enumerable:true,configurable:true});FormContextBuilder.prototype.completeOpenPromise=function(openAllResults){var flattenedTry=fp_1.Try.flatten(openAllResults);if(flattenedTry.isFailure){return new fp_5.Failure("FormContextBuilder::build: "+util_2.ObjUtil.formatRecAttr(flattenedTry.failure))}var flattened=flattenedTry.success;if(flattened.length!=4)return new fp_5.Failure("FormContextBuilder::build: Open form should have resulted in 4 elements");var formXOpen=flattened[0];var formXFormDef=flattened[1];var formMenuDefs=flattened[2];var formChildren=flattened[3];if(formChildren.length!=4)return new fp_5.Failure("FormContextBuilder::build: Open form should have resulted in 3 elements for children panes");var childrenXOpens=formChildren[0];var childrenXPaneDefs=formChildren[1];var childrenXActiveColDefs=formChildren[2];var childrenMenuDefs=formChildren[3];return FormDef.fromOpenFormResult(formXOpen,formXFormDef,formMenuDefs,childrenXOpens,childrenXPaneDefs,childrenXActiveColDefs,childrenMenuDefs)};FormContextBuilder.prototype.createChildrenContexts=function(formDef){var result=[];formDef.childrenDefs.forEach(function(paneDef,i){if(paneDef instanceof ListDef){result.push(new ListContext(i))}else if(paneDef instanceof DetailsDef){result.push(new DetailsContext(i))}else if(paneDef instanceof MapDef){result.push(new MapContext(i))}else if(paneDef instanceof GraphDef){result.push(new GraphContext(i))}else if(paneDef instanceof CalendarDef){result.push(new CalendarContext(i))}else if(paneDef instanceof ImagePickerDef){result.push(new ImagePickerContext(i))}else if(paneDef instanceof BarcodeScanDef){result.push(new BarcodeScanContext(i))}else if(paneDef instanceof GeoFixDef){result.push(new GeoFixContext(i))}else if(paneDef instanceof GeoLocationDef){result.push(new GeoLocationContext(i))}});return result};FormContextBuilder.prototype.fetchChildrenActiveColDefs=function(formXOpen){var _this=this;var xComps=formXOpen.formModel.children;var seqOfFutures=xComps.map(function(xComp){if(xComp.redirection.isQuery){return DialogService.getActiveColumnDefs(xComp.redirection.dialogHandle,_this.sessionContext)}else {return fp_3.Future.createSuccessfulFuture("FormContextBuilder::fetchChildrenActiveColDefs",null)}});return fp_3.Future.sequence(seqOfFutures)};FormContextBuilder.prototype.fetchChildrenMenuDefs=function(formXOpen){var _this=this;var xComps=formXOpen.formModel.children;var seqOfFutures=xComps.map(function(xComp){if(xComp.redirection.isEditor){return DialogService.getEditorModelMenuDefs(xComp.redirection.dialogHandle,_this.sessionContext)}else {return DialogService.getQueryModelMenuDefs(xComp.redirection.dialogHandle,_this.sessionContext)}});return fp_3.Future.sequence(seqOfFutures)};FormContextBuilder.prototype.fetchChildrenXPaneDefs=function(formXOpen,xFormDef){var _this=this;var formHandle=formXOpen.formModel.form.redirection.dialogHandle;var xRefs=xFormDef.paneDefRefs;var seqOfFutures=xRefs.map(function(xRef){return DialogService.getEditorModelPaneDef(formHandle,xRef.paneId,_this.sessionContext)});return fp_3.Future.sequence(seqOfFutures)};FormContextBuilder.prototype.fetchXFormDef=function(xformOpenResult){var dialogHandle=xformOpenResult.formRedirection.dialogHandle;var formPaneId=xformOpenResult.formPaneId;return DialogService.getEditorModelPaneDef(dialogHandle,formPaneId,this.sessionContext).bind(function(value){if(value instanceof XFormDef){return fp_3.Future.createSuccessfulFuture("fetchXFormDef/success",value)}else {return fp_3.Future.createFailedFuture("fetchXFormDef/failure","Expected reponse to contain an XFormDef but got "+util_2.ObjUtil.formatRecAttr(value))}})};FormContextBuilder.prototype.openChildren=function(formXOpen){var _this=this;var xComps=formXOpen.formModel.children;var seqOfFutures=[];xComps.forEach(function(nextXComp){var nextFr=null;if(nextXComp.redirection.isEditor){nextFr=DialogService.openEditorModelFromRedir(nextXComp.redirection,_this.sessionContext)}else {nextFr=DialogService.openQueryModelFromRedir(nextXComp.redirection,_this.sessionContext)}seqOfFutures.push(nextFr)});return fp_3.Future.sequence(seqOfFutures)};return FormContextBuilder})();exports.FormContextBuilder=FormContextBuilder; /**
 * *********************************
 */ /*
 ...
 */var GatewayService=(function(){function GatewayService(){}GatewayService.getServiceEndpoint=function(tenantId,serviceName,gatewayHost){ //We have to fake this for now, due to cross domain issues
/*
         var fakeResponse = {
         ...
         */var f=ws_2.Get.fromUrl("https://"+gatewayHost+"/"+tenantId+"/"+serviceName).perform();var endPointFuture=f.bind(function(jsonObject){ //'bounce cast' the jsonObject here to coerce into ServiceEndpoint
return fp_3.Future.createSuccessfulFuture("serviceEndpoint",jsonObject)});return endPointFuture};return GatewayService})();exports.GatewayService=GatewayService; /**
 * *********************************
 */var GeoFix=(function(){function GeoFix(_latitude,_longitude,_source,_accuracy){this._latitude=_latitude;this._longitude=_longitude;this._source=_source;this._accuracy=_accuracy}GeoFix.fromFormattedValue=function(value){var pair=util_4.StringUtil.splitSimpleKeyValuePair(value);return new GeoFix(Number(pair[0]),Number(pair[1]),null,null)};Object.defineProperty(GeoFix.prototype,"latitude",{get:function get(){return this._latitude},enumerable:true,configurable:true});Object.defineProperty(GeoFix.prototype,"longitude",{get:function get(){return this._longitude},enumerable:true,configurable:true});Object.defineProperty(GeoFix.prototype,"source",{get:function get(){return this._source},enumerable:true,configurable:true});Object.defineProperty(GeoFix.prototype,"accuracy",{get:function get(){return this._accuracy},enumerable:true,configurable:true});GeoFix.prototype.toString=function(){return this.latitude+":"+this.longitude};return GeoFix})();exports.GeoFix=GeoFix; /**
 * *********************************
 */var GeoLocation=(function(){function GeoLocation(_latitude,_longitude){this._latitude=_latitude;this._longitude=_longitude}GeoLocation.fromFormattedValue=function(value){var pair=util_4.StringUtil.splitSimpleKeyValuePair(value);return new GeoLocation(Number(pair[0]),Number(pair[1]))};Object.defineProperty(GeoLocation.prototype,"latitude",{get:function get(){return this._latitude},enumerable:true,configurable:true});Object.defineProperty(GeoLocation.prototype,"longitude",{get:function get(){return this._longitude},enumerable:true,configurable:true});GeoLocation.prototype.toString=function(){return this.latitude+":"+this.longitude};return GeoLocation})();exports.GeoLocation=GeoLocation; /**
 * *********************************
 */var GraphDataPointDef=(function(){function GraphDataPointDef(_name,_type,_plotType,_legendkey){this._name=_name;this._type=_type;this._plotType=_plotType;this._legendkey=_legendkey}return GraphDataPointDef})();exports.GraphDataPointDef=GraphDataPointDef; /**
 * *********************************
 */var MenuDef=(function(){function MenuDef(_name,_type,_actionId,_mode,_label,_iconName,_directive,_menuDefs){this._name=_name;this._type=_type;this._actionId=_actionId;this._mode=_mode;this._label=_label;this._iconName=_iconName;this._directive=_directive;this._menuDefs=_menuDefs}Object.defineProperty(MenuDef.prototype,"actionId",{get:function get(){return this._actionId},enumerable:true,configurable:true});Object.defineProperty(MenuDef.prototype,"directive",{get:function get(){return this._directive},enumerable:true,configurable:true});MenuDef.prototype.findAtId=function(actionId){if(this.actionId===actionId)return this;var result=null;this.menuDefs.some(function(md){result=md.findAtId(actionId);return result!=null});return result};Object.defineProperty(MenuDef.prototype,"iconName",{get:function get(){return this._iconName},enumerable:true,configurable:true});Object.defineProperty(MenuDef.prototype,"isPresaveDirective",{get:function get(){return this._directive&&this._directive==="PRESAVE"},enumerable:true,configurable:true});Object.defineProperty(MenuDef.prototype,"isRead",{get:function get(){return this._mode&&this._mode.indexOf("R")>-1},enumerable:true,configurable:true});Object.defineProperty(MenuDef.prototype,"isSeparator",{get:function get(){return this._type&&this._type==="separator"},enumerable:true,configurable:true});Object.defineProperty(MenuDef.prototype,"isWrite",{get:function get(){return this._mode&&this._mode.indexOf("W")>-1},enumerable:true,configurable:true});Object.defineProperty(MenuDef.prototype,"label",{get:function get(){return this._label},enumerable:true,configurable:true});Object.defineProperty(MenuDef.prototype,"menuDefs",{get:function get(){return this._menuDefs},enumerable:true,configurable:true});Object.defineProperty(MenuDef.prototype,"mode",{get:function get(){return this._mode},enumerable:true,configurable:true});Object.defineProperty(MenuDef.prototype,"name",{get:function get(){return this._name},enumerable:true,configurable:true});Object.defineProperty(MenuDef.prototype,"type",{get:function get(){return this._type},enumerable:true,configurable:true});return MenuDef})();exports.MenuDef=MenuDef;var NavRequestUtil=(function(){function NavRequestUtil(){}NavRequestUtil.fromRedirection=function(redirection,actionSource,sessionContext){var result;if(redirection instanceof WebRedirection){result=fp_3.Future.createSuccessfulFuture("NavRequest::fromRedirection",redirection)}else if(redirection instanceof WorkbenchRedirection){var wbr=redirection;result=AppContext.singleton.getWorkbench(sessionContext,wbr.workbenchId).map(function(wb){return wb})}else if(redirection instanceof DialogRedirection){var dr=redirection;var fcb=new FormContextBuilder(dr,actionSource,sessionContext);result=fcb.build()}else if(redirection instanceof NullRedirection){var nullRedir=redirection;var nullNavRequest=new NullNavRequest;util_2.ObjUtil.addAllProps(nullRedir.fromDialogProperties,nullNavRequest.fromDialogProperties);result=fp_3.Future.createSuccessfulFuture("NavRequest:fromRedirection/nullRedirection",nullNavRequest)}else {result=fp_3.Future.createFailedFuture("NavRequest::fromRedirection","Unrecognized type of Redirection "+util_2.ObjUtil.formatRecAttr(redirection))}return result};return NavRequestUtil})();exports.NavRequestUtil=NavRequestUtil; /**
 * *********************************
 ...
 */var XFormModel=(function(){function XFormModel(form,header,children,placement,refreshTimer,sizeToWindow){this.form=form;this.header=header;this.children=children;this.placement=placement;this.refreshTimer=refreshTimer;this.sizeToWindow=sizeToWindow} /*
     ...
     */XFormModel.fromWS=function(otype,jsonObj){return DialogTriple.fromWSDialogObject(jsonObj["form"],"WSFormModelComp",OType.factoryFn,true).bind(function(form){var header=null;if(jsonObj["header"]){var headerTry=DialogTriple.fromWSDialogObject(jsonObj["header"],"WSFormModelComp",OType.factoryFn,true);if(headerTry.isFailure)return new fp_5.Failure(headerTry.isFailure);header=headerTry.success}return DialogTriple.fromListOfWSDialogObject(jsonObj["children"],"WSFormModelComp",OType.factoryFn,true).bind(function(children){return new fp_4.Success(new XFormModel(form,header,children,jsonObj["placement"],jsonObj["refreshTimer"],jsonObj["sizeToWindow"]))})})};return XFormModel})();exports.XFormModel=XFormModel; /**
 * *********************************
 ...
 * *********************************
 */var XWriteResult=(function(){function XWriteResult(_editorRecord,_editorRecordDef,_dialogProperties){this._editorRecord=_editorRecord;this._editorRecordDef=_editorRecordDef;this._dialogProperties=_dialogProperties}XWriteResult.fromWS=function(otype,jsonObj){return DialogTriple.extractTriple(jsonObj,"WSWriteResult",function(){return OType.deserializeObject(jsonObj,"XWriteResult",OType.factoryFn)})};Object.defineProperty(XWriteResult.prototype,"dialogProps",{get:function get(){return this._dialogProperties},enumerable:true,configurable:true});Object.defineProperty(XWriteResult.prototype,"entityRec",{get:function get(){return this._editorRecord},enumerable:true,configurable:true});Object.defineProperty(XWriteResult.prototype,"entityRecDef",{get:function get(){return this._editorRecordDef},enumerable:true,configurable:true});Object.defineProperty(XWriteResult.prototype,"isDestroyed",{get:function get(){var destoyedStr=this.dialogProps["destroyed"];return destoyedStr&&destoyedStr.toLowerCase()==="true"},enumerable:true,configurable:true});return XWriteResult})();exports.XWriteResult=XWriteResult; /*
  OType must be last as it references almost all other classes in the module
 */var OType=(function(){function OType(){}OType.typeInstance=function(name){var type=OType.types[name];return type&&new type};OType.factoryFn=function(otype,jsonObj){var typeFn=OType.typeFns[otype];if(typeFn){return typeFn(otype,jsonObj)}return null};OType.deserializeObject=function(obj,Otype,factoryFn){util_1.Log.debug("Deserializing "+Otype);if(Array.isArray(obj)){ //it's a nested array (no LTYPE!)
...
},{"./fp":2,"./util":3}],5:[function(require,module,exports){
"use strict";
...
function handleDefaultActionForListItem(index, listContext) {
    ...
    if (entityRecs.length === 0) return fp_1.Future.createSuccessfulFuture('handleDefaultActionForListItem', listContext);
...
function isValidDetailsDefRow(row) {
    return row.length === 2 && row[0].values.length === 1 && row[1].values.length === 1 && (row[0].values[0] instanceof dialog_7.LabelCellValueDef || row[1].values[0] instanceof dialog_8.ForcedLineCellValueDef) && (row[1].values[0] instanceof dialog_9.AttributeCellValueDef || row[1].values[0] instanceof dialog_7.LabelCellValueDef || row[1].values[0] instanceof dialog_8.ForcedLineCellValueDef);
}
function isSectionTitleDef(row) {
    return row[0].values[0] instanceof dialog_7.LabelCellValueDef && row[1].values[0] instanceof dialog_7.LabelCellValueDef;
}
...
},{"../src/catavolt/dialog":1,"../src/catavolt/fp":2,"../src/catavolt/util":3}]},{},[5]);
